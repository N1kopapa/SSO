<template>
<el-dialog class="TenantAdd" title="租户新增" align="center" :visible.sync="dialogFormVisible" :modal-append-to-body='false'>
  ...
  data() {
    return {
      ...
      form: {
        ...
        email: "",
        usageStatus: "",
        // 不要当前状态。。//无效，但不要删除，以后可能有用
        currentStatus: "34232fbf-7225-11e5-9fcc-005056c00008",
        logo: "",
        remark: "",
        createdBy: "",
  ...
  methods: {
    confirm() {
      ...
      addTenant(this.form).then(response => {
        ...
        this.initFormForNextAdd()
        this.form.currentStatus= "34232fbf-7225-11e5-9fcc-005056c00008",
    ...
    handle_success(response, file, fileList) {
      ...
      this.form.logo = process.env.VUE_APP_BASE_API + response.data[0].url;
    },
    // 图片校验
